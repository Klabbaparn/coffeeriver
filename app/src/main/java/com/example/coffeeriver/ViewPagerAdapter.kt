...
class ViewPagerAdapter(private var title: List<String>, private var details: List<String>, private var images: List<Int>) : RecyclerView.Adapter<ViewPagerAdapter.Pager2ViewHolder>() {
    ...
    inner class Pager2ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        val itemDetails: TextView = itemView.findViewById(R.id.about)
        ...
        init {
            ...
            itemImage.setOnClickListener {v: View ->
                ...
                Toast.makeText(itemView.context, "You clicked on station ${position + 1}", Toast.LENGTH_SHORT).show()
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewPagerAdapter.Pager2ViewHolder {
        return Pager2ViewHolder(LayoutInflater.from(parent.context).inflate(R.layout.station_page, parent, false))
    }
